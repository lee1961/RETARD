...
class HFDriver extends TestDriver implements GlobalConst
{
	...
	protected boolean test1 ()  {
      ...
      //  System.out.println("buffer unpinned is " + Minibase.BufferManager.getNumUnpinned());
        //System.out.println("heap[ file lefg pages unpinned is " + Minibase.BufferManager.getNumBuffers());
